import {Component, effect, EventEmitter, inject, Input, input, Output, ViewEncapsulation} from '@angular/core';
...
export class LocationMapComponent {
  ...
  @Input()
  placeholder: string = 'Selectionnez votre localisation';

  //placeholder = input<string>("Selectionnez votre localisation");
    ...
    effect(() => {
      ...
      if (countriesState.status === "OK" && countriesState.value) {
        ...
        this.toastService.send({
          ...
          detail: "Il y'a eu une erreur lors de la selection"
        });
      }
    });
  }
